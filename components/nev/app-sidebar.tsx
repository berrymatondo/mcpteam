  ...
  return (
    <>
      ...
      >
        <SidebarHeader className="border-b border-border/40 p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold">OrganizationHub</span>
        ...
        <SidebarFooter
          className={`border-t border-border/40 ${isMobile ? "p-2" : "p-4"}`}
        >
          {isLoggedIn ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div
                  className={`flex items-center gap-3 cursor-pointer hover:bg-muted/50 rounded-lg transition-colors ${
                    isMobile ? "p-3" : "p-2"
                  }`}
                >
            ...
            <div className="space-y-2">
              <button
                onClick={handleLogin}
                className={`w-full flex items-center gap-2 text-sm font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors ${
              ...
              <button
                ...
                className={`w-full flex items-center gap-2 text-sm font-medium rounded-lg border border-border hover:bg-muted/50 transition-colors ${
                  isMobile ? "px-4 py-3" : "px-3 py-2"
                }`}
              >
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setProfileForm((prev) => ({ ...prev, statut: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
